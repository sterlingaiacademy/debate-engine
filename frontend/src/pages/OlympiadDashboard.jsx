...
const SUBJECTS = [
  { key: 'English', label: 'English', desc: 'Grammar, comprehension & vocabulary — grade-specific MCQs.', grad: 'linear-gradient(135deg,#ff6b6b,#ee0979)', shadow: 'rgba(238,9,121,0.28)', light: '#ff6b6b' },
  { key: 'Mathematics', label: 'Mathematics', desc: 'Problem-solving & key mathematical concepts for your grade.', grad: 'linear-gradient(135deg,#4facfe,#00f2fe)', shadow: 'rgba(79,172,254,0.28)', light: '#4facfe' },
  { key: 'Science', label: 'Science', desc: 'Physics, Chemistry & Biology — tailored for your grade.', grad: 'linear-gradient(135deg,#43e97b,#38f9d7)', shadow: 'rgba(67,233,123,0.28)', light: '#43e97b' },
  { key: 'Social Sciences', label: 'Social Sciences', desc: 'History, Geography & Global Citizenship MCQs.', grad: 'linear-gradient(135deg,#f7971e,#ffd200)', shadow: 'rgba(247,151,30,0.28)', light: '#f7971e' },
  { key: 'CT & AI', label: 'CT & AI', desc: 'Computational Thinking, Digital Citizenship & AI.', grad: 'linear-gradient(135deg,#a18cd1,#fbc2eb)', shadow: 'rgba(161,140,209,0.28)', light: '#a18cd1' },
];
    ...
    <div style={{ minHeight: '100vh', background: 'radial-gradient(ellipse at top left, #1a0a2e 0%, #0d0d1a 40%, #0a0a0f 100%)', color: '#f8fafc', fontFamily: FONT, position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ maxWidth: 1100, margin: '0 auto', padding: '2rem 1.5rem' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(280px, 1fr))', gap: '1rem', opacity: 0.45 }}>
          {[
            { label: 'Daily Practice', desc: 'Sharpen your brain with daily questions tailored for you.' },
            { label: 'Mock Exam', desc: 'Full-length test — unlocks before the main Olympiad event.' },
            { label: 'Rules & Guide', desc: 'Topics, instructions, and everything you need to know.' },
          ].map(item => (
