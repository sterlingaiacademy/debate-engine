...
export default function OlympiadEnglishQuiz({ user, subject = 'English', onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-[100] bg-bg-base dark:bg-dark-base overflow-y-auto text-text-main dark:text-white">
      <div className="min-h-full flex flex-col justify-center" style={{ padding: '2rem 1rem' }}>
          ...
          <div className="px-6 md:px-8 flex justify-between items-start sm:items-center border-b border-gray-200 dark:border-white/[0.03] gap-4" style={{ paddingTop: '1.5rem', paddingBottom: '1.5rem' }}>
            ...
            <div className="flex gap-4 shrink-0">
              <div className="bg-bg-base dark:bg-dark-base shadow-neo-btn-portal dark:shadow-neo-btn-dark-portal rounded-full px-4 py-1.5 flex items-center gap-1.5 hidden sm:flex">
                ...
                <span className="text-sm text-text-main dark:text-white/90 font-bold">{current + 1}/{total}</span>
              </div>
