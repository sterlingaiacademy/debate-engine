        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
          ...
          <div>
            ...
            <p style={{ margin: '0.15rem 0 0', fontSize: '0.82rem', color: 'var(--text-secondary)', display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
              ...
              {user.classLevel && <><span style={{ opacity: 0.4 }}>•</span><span style={{ color: tier.color, fontWeight: 700 }}>{user.grade ? (user.grade.startsWith('Class') ? user.grade.replace('Class', 'Grade') : user.grade) : user.classLevel}</span></>}
            </p>
          </div>
        </div>
