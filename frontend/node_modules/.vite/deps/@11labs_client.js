  ...
  m2.forEach(function(e2) {
    e2 && typeof e2 !== "string" && !Array.isArray(e2) && Object.keys(e2).forEach(function(k2) {
      if (k2 !== "default" && !(k2 in n)) {
        ...
        Object.defineProperty(n, k2, d2.get ? d2 : { enumerable: true, get: function() {
          return e2[k2];
        } });
      }
    });
...
var DataTrackInfo = proto3.makeMessageType("livekit.DataTrackInfo", () => [{
  no: 1,
  name: "pub_handle",
  kind: "scalar",
  T: 13
...
function layerDimensionsFor(trackInfo, quality) {
  var _a2;
  return (_a2 = trackInfo.layers) === null || _a2 === void 0 ? void 0 : _a2.find((l2) => l2.quality === quality);
}
  ...
  setRemoteDescription(sd, offerId) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (sd.type === "offer") {
        ...
        const sdpParsed = libExports.parse((_a2 = sd.sdp) !== null && _a2 !== void 0 ? _a2 : "");
    ...
    if (!ddFound) {
      if (this.ddExtID === 0) {
        ...
        sdp2.media.forEach((m2) => {
          ...
          (_a3 = m2.ext) === null || _a3 === void 0 ? void 0 : _a3.forEach((ext) => {
            if (ext.value > maxID) {
              maxID = ext.value;
            }
          });
...
var LocalVideoTrack = class extends LocalTrack {
  ...
  getSenderStats() {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      stats.forEach((v2) => {
        ...
        if (v2.type === "outbound-rtp") {
          const vs = {
            ...
            rid: (_a3 = v2.rid) !== null && _a3 !== void 0 ? _a3 : v2.id,
      ...
      items.sort((a2, b2) => {
        var _a3, _b2;
        return ((_a3 = b2.frameWidth) !== null && _a3 !== void 0 ? _a3 : 0) - ((_b2 = a2.frameWidth) !== null && _b2 !== void 0 ? _b2 : 0);
      });
      return items;
    });
  }
...
var RTCEngine = class extends eventsExports.EventEmitter {
  ...
  configure(joinResponse, useSinglePeerConnection) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (!supportOptionalDatachannel((_b2 = joinResponse.serverInfo) === null || _b2 === void 0 ? void 0 : _b2.protocol)) {
...
var ByteStreamReader = class extends BaseStreamReader {
  ...
  [Symbol.asyncIterator]() {
    ...
    if (this.signal) {
      ...
      onAbort = () => {
        var _a2;
        (_a2 = rejectingSignalFuture.reject) === null || _a2 === void 0 ? void 0 : _a2.call(rejectingSignalFuture, signal.reason);
      };
      ...
      next: () => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
          const {
            ...
            (_b2 = (_a2 = this.outOfBandFailureRejectingFuture) === null || _a2 === void 0 ? void 0 : _a2.promise) !== null && _b2 !== void 0 ? _b2 : new Promise(() => {
            })
          ]);
          if (done) {
  ...
  validateParticipantHasNoActiveDataStreams(participantIdentity) {
    ...
    if (textStreamsBeingSentByDisconnectingParticipant.length > 0 || byteStreamsBeingSentByDisconnectingParticipant.length > 0) {
      ...
      for (const [id, controller] of byteStreamsBeingSentByDisconnectingParticipant) {
        (_b2 = (_a2 = controller.outOfBandFailureRejectingFuture).reject) === null || _b2 === void 0 ? void 0 : _b2.call(_a2, abnormalEndError);
...
var Room = class _Room extends eventsExports.EventEmitter {
  ...
  constructor(options) {
    ...
    if ((_b2 = this.options.audioOutput) === null || _b2 === void 0 ? void 0 : _b2.deviceId) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      for (let i2 = 0; i2 < participantOptions.count - 1; i2 += 1) {
        ...
        if (participantOptions.video) {
          const dummyVideo = createDummyVideoStreamTrack(160 * ((_d = participantOptions.aspectRatios[i2 % participantOptions.aspectRatios.length]) !== null && _d !== void 0 ? _d : 1), 160, false, true);
...
var DataTrackUserTimestampExtension = class _DataTrackUserTimestampExtension extends DataTrackExtension {
  ...
  toBinaryLengthBytes() {
    return U16_LENGTH_BYTES + U16_LENGTH_BYTES + _DataTrackUserTimestampExtension.lengthBytes;
  }
  toBinaryInto(dataView) {
    let byteIndex = 0;
    dataView.setUint16(byteIndex, _DataTrackUserTimestampExtension.tag);
    byteIndex += U16_LENGTH_BYTES;
    const rtpOrientedLength = _DataTrackUserTimestampExtension.lengthBytes - 1;
...
var DataTrackE2eeExtension = class _DataTrackE2eeExtension extends DataTrackExtension {
  ...
  toBinaryLengthBytes() {
    return U16_LENGTH_BYTES + U16_LENGTH_BYTES + _DataTrackE2eeExtension.lengthBytes;
  }
  toBinaryInto(dataView) {
    let byteIndex = 0;
    dataView.setUint16(byteIndex, _DataTrackE2eeExtension.tag);
    byteIndex += U16_LENGTH_BYTES;
    const rtpOrientedLength = _DataTrackE2eeExtension.lengthBytes - 1;
    dataView.setUint16(byteIndex, rtpOrientedLength);
    byteIndex += U16_LENGTH_BYTES;
    dataView.setUint8(byteIndex, this.keyIndex);
    byteIndex += U8_LENGTH_BYTES;
    for (let i2 = 0; i2 < this.iv.length; i2 += 1) {
      dataView.setUint8(byteIndex, this.iv[i2]);
      byteIndex += U8_LENGTH_BYTES;
    }
    const totalLengthBytes = this.toBinaryLengthBytes();
    if (byteIndex !== totalLengthBytes) {
...
getLogger(LoggerNames.DataTracks);
...
var d = "conversation_initiation_client_data";
function h2(e2) {
  const t = { type: d };
  var n, s, o3, a2, i2;
...
var p = class _p extends r2 {
  ...
  static async create(e2) {
    ...
    try {
      var n, s, o3;
      const a3 = null != (n = e2.origin) ? n : "wss://api.elevenlabs.io";
      let i2;
      const r3 = (null == (s = e2.overrides) || null == (s = s.client) ? void 0 : s.version) || l, d2 = (null == (o3 = e2.overrides) || null == (o3 = o3.client) ? void 0 : o3.source) || "js_sdk";
      if (e2.signedUrl) {
        const t2 = e2.signedUrl.includes("?") ? "&" : "?";
        i2 = `${e2.signedUrl}${t2}source=${d2}&version=${r3}`;
      } else i2 = `${a3}/v1/convai/conversation?agent_id=${e2.agentId}&source=${d2}&version=${r3}`;
      const m2 = ["convai"];
      e2.authorization && m2.push(`bearer.${e2.authorization}`), t = new WebSocket(i2, m2);
      const g2 = await new Promise((n2, s2) => {
        t.addEventListener("open", () => {
          var n3;
          const s3 = h2(e2);
          null == (n3 = t) || n3.send(JSON.stringify(s3));
        }, { once: true }), t.addEventListener("error", (e3) => {
          setTimeout(() => s2(e3), 0);
        }), t.addEventListener("close", s2), t.addEventListener("message", (e3) => {
          const t2 = JSON.parse(e3.data);
          u(t2) && ("conversation_initiation_metadata" === t2.type ? n2(t2.conversation_initiation_metadata_event) : console.warn("First received message is not conversation metadata."));
        }, { once: true });
      }), { conversation_id: v2, agent_output_audio_format: f2, user_input_audio_format: w2 } = g2, y2 = c(null != w2 ? w2 : "pcm_16000"), _3 = c(f2);
      return new _p(t, v2, y2, _3);
    } catch (e3) {
      var a2;
      throw null == (a2 = t) || a2.close(), e3;
    }
  }
  close() {
    this.socket.close();
...
var m = class _m extends r2 {
  ...
  static async create(n) {
    ...
    if ("conversationToken" in n && n.conversationToken) s = n.conversationToken;
      ...
      try {
        var o3, a2;
        const e2 = (null == (o3 = n.overrides) || null == (o3 = o3.client) ? void 0 : o3.version) || l, t = (null == (a2 = n.overrides) || null == (a2 = a2.client) ? void 0 : a2.source) || "js_sdk", i3 = `https://api.elevenlabs.io/v1/convai/conversation/token?agent_id=${n.agentId}&source=${t}&version=${e2}`, r3 = await fetch(i3);
        if (!r3.ok) throw new Error(`ElevenLabs API returned ${r3.status} ${r3.statusText}`);
        if (s = (await r3.json()).token, !s) throw new Error("No conversation token received from API");
      } catch (e2) {
    ...
    const i2 = new Room();
    try {
      const e2 = `webrtc-${Date.now()}`, o4 = c("pcm_48000"), a3 = c("pcm_48000"), r3 = new _m(i2, e2, o4, a3, n), l2 = n.livekitUrl || "wss://livekit.rtc.elevenlabs.io";
      await i2.connect(l2, s), await new Promise((e3) => {
        if (r3.isConnected) e3();
        else {
          const n2 = () => {
            i2.off(RoomEvent.Connected, n2), e3();
          };
          i2.on(RoomEvent.Connected, n2);
        }
      }), i2.name && (r3.conversationId = i2.name), await i2.localParticipant.setMicrophoneEnabled(true);
      const u2 = h2(n);
      return r3.debug({ type: d, message: u2 }), await r3.sendMessage(u2), r3;
    } catch (e2) {
      throw await i2.disconnect(), e2;
    }
  }
  setupRoomEventListeners() {
    ...
    this.room.on(RoomEvent.Connected, async function() {
      ...
      try {
        ...
        u(t2) ? this.handleMessage(t2) : console.warn("Invalid socket event received:", t2);
      } catch (t2) {
...
var w = class _w extends i {
  static async startSession(e2) {
    ...
    let n = null;
    try {
      return await f(t.connectionDelay), n = await g(e2), new _w(t, n);
    } catch (e3) {
      var s;
...
var S = class _S {
  static async create({ sampleRate: e2, format: t, preferHeadphonesForIosDevices: n }) {
    ...
    try {
      ...
      i3 || await s.audioWorklet.addModule("https://cdn.jsdelivr.net/npm/@alexanderolsen/libsamplerate-js@2.1.2/dist/libsamplerate.worklet.js"), await C(s.audioWorklet), o3 = await navigator.mediaDevices.getUserMedia({ audio: a3 });
      const c2 = s.createMediaStreamSource(o3), l2 = new AudioWorkletNode(s, "raw-audio-processor");
      return l2.port.postMessage({ type: "setFormat", format: t, sampleRate: e2 }), c2.connect(r3), r3.connect(l2), await s.resume(), new _S(s, r3, l2, o3);
    } catch (e3) {
      var a2, i2;
...
var I = class _I {
  static async create({ sampleRate: e2, format: t }) {
    ...
    try {
      ...
      o3.connect(s2), s2.connect(n.destination), await M(n.audioWorklet);
      const a2 = new AudioWorkletNode(n, "audio-concat-processor");
      return a2.port.postMessage({ type: "setFormat", format: t }), a2.connect(o3), await n.resume(), new _I(n, s2, o3, a2);
    } catch (e3) {
      var s;
...
var F = class _F extends i {
  static async startSession(e2) {
    ...
    try {
      var u2;
      return c2 = await navigator.mediaDevices.getUserMedia({ audio: true }), await f(n.connectionDelay), a2 = await g(e2), [s, r3] = await Promise.all([S.create(o2({}, a2.inputFormat, { preferHeadphonesForIosDevices: e2.preferHeadphonesForIosDevices })), I.create(a2.outputFormat)]), null == (u2 = c2) || u2.getTracks().forEach((e3) => e3.stop()), c2 = null, new _F(n, a2, s, r3, l2);
    } catch (e3) {
      var d2, h3, p2, m2;
      n.onStatusChange({ status: "disconnected" }), null == (d2 = c2) || d2.getTracks().forEach((e4) => e4.stop()), null == (h3 = a2) || h3.close(), await (null == (p2 = s) ? void 0 : p2.close()), await (null == (m2 = r3) ? void 0 : m2.close());
      try {
        var v2;
  ...
  constructor(e2, t, n, s, o3) {
    super(e2, t), this.input = void 0, this.output = void 0, this.wakeLock = void 0, this.inputFrequencyData = void 0, this.outputFrequencyData = void 0, this.onInputWorkletMessage = (e3) => {
      "connected" === this.status && this.connection.sendMessage({ user_audio_chunk: y(e3.data[0].buffer) });
      ...
      this.output.gain.gain.value = this.volume, this.output.worklet.port.postMessage({ type: "clearInterrupted" }), this.output.worklet.port.postMessage({ type: "buffer", buffer: _2(e3) });
    }, this.fadeOutAudio = () => {
...
function D(e2, t, n = "https://api.elevenlabs.io") {
...
var x = class extends i {
  static startSession(e2) {
    return e2.textOnly ? w.startSession(e2) : F.startSession(e2);
  }
};
export {
  x as Conversation,
  m as WebRTCConnection,
  p as WebSocketConnection,
  g as createConnection,
  D as postOverallFeedback
};
